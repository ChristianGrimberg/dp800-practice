...
unidad: 'Unidad 2.2.6 — Identificar y resolver bloqueos e interbloqueos'
codigo: 2.2.6
...
# Unidad 2.2.6 — Identificar y resolver bloqueos e interbloqueos

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/optimize-database-performance/06-identify-resolve-blocking-deadlocks/)
