...
unidad: 'Unidad 2.2.1 — Introducción'
codigo: 2.2.1
...
# Unidad 2.2.1 — Introducción

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/optimize-database-performance/01-introduction/)
