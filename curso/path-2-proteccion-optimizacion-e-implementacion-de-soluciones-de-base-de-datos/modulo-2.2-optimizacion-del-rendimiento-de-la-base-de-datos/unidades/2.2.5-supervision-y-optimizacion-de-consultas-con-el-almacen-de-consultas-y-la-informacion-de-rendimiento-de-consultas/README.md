...
unidad: 'Unidad 2.2.5 — Supervisión y optimización de consultas con el almacén de consultas y la información de rendimiento de consultas'
codigo: 2.2.5
...
# Unidad 2.2.5 — Supervisión y optimización de consultas con el almacén de consultas y la información de rendimiento de consultas

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/optimize-database-performance/05-monitor-tune-queries-query-store/)
