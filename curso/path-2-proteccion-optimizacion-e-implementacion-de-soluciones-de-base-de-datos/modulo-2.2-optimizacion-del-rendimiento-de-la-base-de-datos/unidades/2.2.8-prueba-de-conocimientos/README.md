...
unidad: 'Unidad 2.2.8 — Prueba de conocimientos'
codigo: 2.2.8
...
# Unidad 2.2.8 — Prueba de conocimientos

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/optimize-database-performance/08-knowledge-check/)
