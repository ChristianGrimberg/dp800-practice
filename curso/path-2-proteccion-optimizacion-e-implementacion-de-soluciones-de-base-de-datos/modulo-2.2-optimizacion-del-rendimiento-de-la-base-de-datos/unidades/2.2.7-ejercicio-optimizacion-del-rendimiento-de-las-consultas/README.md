...
unidad: 'Unidad 2.2.7 — Ejercicio: Optimización del rendimiento de las consultas'
codigo: 2.2.7
...
# Unidad 2.2.7 — Ejercicio: Optimización del rendimiento de las consultas

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/optimize-database-performance/07-exercise-optimize-query-performance/)
