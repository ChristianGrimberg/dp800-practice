...
unidad: 'Unidad 2.2.2 — Recomendar configuraciones de base de datos'
codigo: 2.2.2
...
# Unidad 2.2.2 — Recomendar configuraciones de base de datos

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/optimize-database-performance/02-recommend-database-configurations/)
