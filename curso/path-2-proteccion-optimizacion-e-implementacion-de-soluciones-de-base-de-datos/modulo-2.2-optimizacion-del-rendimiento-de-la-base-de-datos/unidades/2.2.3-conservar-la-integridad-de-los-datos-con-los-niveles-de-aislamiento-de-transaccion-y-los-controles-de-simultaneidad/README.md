...
modulo: 'Módulo 2.2 — Optimización del rendimiento de la base de datos'
unidad: 'Unidad 2.2.3 — Conservar la integridad de los datos con los niveles de aislamiento de transacción y los controles de simultaneidad'
codigo: 2.2.3
...
# Unidad 2.2.3 — Conservar la integridad de los datos con los niveles de aislamiento de transacción y los controles de simultaneidad

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/optimize-database-performance/03-preserve-data-integrity-isolation-levels/)

**Duración estimada**: 10 minutos · **Categoría**: leccion
