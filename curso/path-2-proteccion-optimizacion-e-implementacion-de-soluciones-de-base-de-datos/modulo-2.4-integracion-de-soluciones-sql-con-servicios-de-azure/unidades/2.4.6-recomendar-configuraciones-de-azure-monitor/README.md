...
unidad: 'Unidad 2.4.6 — Recomendar configuraciones de Azure Monitor'
codigo: 2.4.6
...
# Unidad 2.4.6 — Recomendar configuraciones de Azure Monitor

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/integrate-sql-solutions-azure-services/6-recommend-azure-monitor-configurations/)
