...
unidad: 'Unidad 2.4.1 — Introducción'
codigo: 2.4.1
...
# Unidad 2.4.1 — Introducción

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/integrate-sql-solutions-azure-services/1-introduction/)
