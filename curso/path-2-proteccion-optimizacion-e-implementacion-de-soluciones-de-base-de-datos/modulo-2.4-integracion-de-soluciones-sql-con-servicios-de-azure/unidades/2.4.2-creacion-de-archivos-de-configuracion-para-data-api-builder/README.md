...
unidad: 'Unidad 2.4.2 — Creación de archivos de configuración para Data API Builder'
codigo: 2.4.2
...
# Unidad 2.4.2 — Creación de archivos de configuración para Data API Builder

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/integrate-sql-solutions-azure-services/2-create-configuration-files-data-api-builder/)
