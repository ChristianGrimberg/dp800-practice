...
unidad: 'Unidad 2.4.7 — Control de cambios con patrones controlados por eventos'
codigo: 2.4.7
...
# Unidad 2.4.7 — Control de cambios con patrones controlados por eventos

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/integrate-sql-solutions-azure-services/7-handle-changes-event-driven-patterns/)
