...
unidad: 'Unidad 2.4.3 — Definición de entidades para REST y GraphQL'
codigo: 2.4.3
...
# Unidad 2.4.3 — Definición de entidades para REST y GraphQL

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/integrate-sql-solutions-azure-services/3-define-entities-rest-graphql/)
