...
unidad: 'Unidad 2.3.8 — Ejercicio: Implementación de CI/CD mediante proyectos de SQL Database'
codigo: 2.3.8
...
# Unidad 2.3.8 — Ejercicio: Implementación de CI/CD mediante proyectos de SQL Database

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-cicd-sql-database-projects/08-exercise-implement-cicd-sql-database-projects/)

**Duración estimada**: 45 minutos · **Categoría**: lab
