...
unidad: 'Unidad 2.3.6 — Implementación de canalizaciones de CI/CD'
codigo: 2.3.6
...
# Unidad 2.3.6 — Implementación de canalizaciones de CI/CD

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-cicd-sql-database-projects/06-implement-cicd-pipelines/)
