...
unidad: 'Unidad 2.3.1 — Introducción'
codigo: 2.3.1
slug: 2.3.1-introduccion
categoria: introduccion
url: https://learn.microsoft.com/es-mx/training/modules/implement-cicd-sql-database-projects/01-introduction/
duracion_min: 3
...
# Unidad 2.3.1 — Introducción

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-cicd-sql-database-projects/01-introduction/)
