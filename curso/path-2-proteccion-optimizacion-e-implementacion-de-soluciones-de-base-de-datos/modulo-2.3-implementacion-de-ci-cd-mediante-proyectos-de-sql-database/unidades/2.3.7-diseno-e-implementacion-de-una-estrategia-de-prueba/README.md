...
unidad: 'Unidad 2.3.7 — Diseño e implementación de una estrategia de prueba'
codigo: 2.3.7
...
# Unidad 2.3.7 — Diseño e implementación de una estrategia de prueba

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-cicd-sql-database-projects/07-design-implement-testing-strategy/)
