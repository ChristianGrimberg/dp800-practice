...
unidad: 'Unidad 2.3.5 — Detección y resolución de la deriva del esquema'
codigo: 2.3.5
...
# Unidad 2.3.5 — Detección y resolución de la deriva del esquema

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-cicd-sql-database-projects/05-detect-resolve-schema-drift/)
