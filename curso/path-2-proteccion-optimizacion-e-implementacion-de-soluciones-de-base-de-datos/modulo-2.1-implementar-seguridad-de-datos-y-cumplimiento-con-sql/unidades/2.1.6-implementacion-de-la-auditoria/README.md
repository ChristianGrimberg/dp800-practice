...
unidad: 'Unidad 2.1.6 — Implementación de la auditoría'
codigo: 2.1.6
...
# Unidad 2.1.6 — Implementación de la auditoría

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-data-security-compliance/6-implement-auditing/)
