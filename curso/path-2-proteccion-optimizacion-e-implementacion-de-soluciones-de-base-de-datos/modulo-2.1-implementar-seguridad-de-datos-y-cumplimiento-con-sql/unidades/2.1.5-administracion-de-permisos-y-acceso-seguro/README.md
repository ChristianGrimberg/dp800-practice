...
unidad: 'Unidad 2.1.5 — Administración de permisos y acceso seguro'
codigo: 2.1.5
...
# Unidad 2.1.5 — Administración de permisos y acceso seguro

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-data-security-compliance/5-design-implement-object-level-permissions/)
