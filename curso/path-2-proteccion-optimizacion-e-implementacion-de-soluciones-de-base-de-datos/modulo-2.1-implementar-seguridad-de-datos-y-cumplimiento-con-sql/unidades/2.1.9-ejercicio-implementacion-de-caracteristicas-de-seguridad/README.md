...
unidad: 'Unidad 2.1.9 — Ejercicio: Implementación de características de seguridad'
codigo: 2.1.9
...
# Unidad 2.1.9 — Ejercicio: Implementación de características de seguridad

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-data-security-compliance/9-exercise-implement-security-features/)
