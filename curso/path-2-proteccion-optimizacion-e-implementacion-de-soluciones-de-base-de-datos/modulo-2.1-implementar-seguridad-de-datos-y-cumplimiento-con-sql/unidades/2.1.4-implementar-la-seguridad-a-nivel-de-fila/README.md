...
unidad: 'Unidad 2.1.4 — Implementar la seguridad a nivel de fila'
codigo: 2.1.4
...
# Unidad 2.1.4 — Implementar la seguridad a nivel de fila

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-data-security-compliance/4-design-implement-row-level-security/)
