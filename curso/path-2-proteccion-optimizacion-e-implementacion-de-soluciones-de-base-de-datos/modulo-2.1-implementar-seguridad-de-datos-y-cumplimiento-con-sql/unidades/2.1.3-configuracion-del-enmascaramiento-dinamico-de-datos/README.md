...
unidad: 'Unidad 2.1.3 — Configuración del enmascaramiento dinámico de datos'
codigo: 2.1.3
...
# Unidad 2.1.3 — Configuración del enmascaramiento dinámico de datos

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-data-security-compliance/3-design-implement-dynamic-data-masking/)
