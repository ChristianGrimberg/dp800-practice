...
unidad: 'Unidad 2.1.7 — Configuración del acceso seguro a los servicios de IA'
codigo: 2.1.7
...
# Unidad 2.1.7 — Configuración del acceso seguro a los servicios de IA

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-data-security-compliance/7-secure-model-endpoints/)
