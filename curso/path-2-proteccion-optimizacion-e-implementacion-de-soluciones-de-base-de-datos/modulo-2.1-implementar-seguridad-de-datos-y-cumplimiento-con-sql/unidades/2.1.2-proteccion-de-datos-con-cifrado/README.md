...
unidad: 'Unidad 2.1.2 — Protección de datos con cifrado'
codigo: 2.1.2
...
# Unidad 2.1.2 — Protección de datos con cifrado

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-data-security-compliance/2-design-implement-data-encryption/)
