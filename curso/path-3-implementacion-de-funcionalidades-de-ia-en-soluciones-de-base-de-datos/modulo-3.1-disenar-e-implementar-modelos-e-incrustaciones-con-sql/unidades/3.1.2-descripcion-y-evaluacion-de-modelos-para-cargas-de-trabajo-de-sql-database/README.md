...
unidad: 'Unidad 3.1.2 — Descripción y evaluación de modelos para cargas de trabajo de SQL Database'
codigo: 3.1.2
...
# Unidad 3.1.2 — Descripción y evaluación de modelos para cargas de trabajo de SQL Database

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-models-embeddings-with-sql/02-understand-evaluate-models-sql-database-workloads/)

**Duración estimada**: 8 minutos · **Categoría**: quiz
