...
unidad: 'Unidad 3.1.5 — Generación y mantenimiento de incrustaciones para cargas de trabajo de SQL Database'
codigo: 3.1.5
...
# Unidad 3.1.5 — Generación y mantenimiento de incrustaciones para cargas de trabajo de SQL Database

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-models-embeddings-with-sql/05-generate-maintain-embeddings-sql-database-workloads/)
