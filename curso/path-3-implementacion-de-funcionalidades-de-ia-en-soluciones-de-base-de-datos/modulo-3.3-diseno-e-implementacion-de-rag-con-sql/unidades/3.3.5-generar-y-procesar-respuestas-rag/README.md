...
unidad: 'Unidad 3.3.5 — Generar y procesar respuestas RAG'
codigo: 3.3.5
...
# Unidad 3.3.5 — Generar y procesar respuestas RAG

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-rag-with-sql/5-generate-process-rag-responses/)
