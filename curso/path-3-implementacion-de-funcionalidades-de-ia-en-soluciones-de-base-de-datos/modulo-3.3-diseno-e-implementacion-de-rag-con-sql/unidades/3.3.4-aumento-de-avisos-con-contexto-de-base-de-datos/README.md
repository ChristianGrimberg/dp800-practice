...
unidad: 'Unidad 3.3.4 — Aumento de avisos con contexto de base de datos'
codigo: 3.3.4
...
# Unidad 3.3.4 — Aumento de avisos con contexto de base de datos

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-rag-with-sql/4-augment-prompts-database-context/)
