...
unidad: 'Unidad 3.3.1 — Introducción'
codigo: 3.3.1
...
**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-rag-with-sql/1-introduction/)
