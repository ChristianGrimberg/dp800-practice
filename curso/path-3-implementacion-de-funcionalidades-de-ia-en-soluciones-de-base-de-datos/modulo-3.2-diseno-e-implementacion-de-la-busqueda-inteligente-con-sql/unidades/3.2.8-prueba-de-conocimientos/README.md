...
unidad: 'Unidad 3.2.8 — Prueba de conocimientos'
codigo: 3.2.8
...
# Unidad 3.2.8 — Prueba de conocimientos

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-intelligent-search-with-sql/08-knowledge-check/)
