...
modulo: 'Módulo 3.2 — Diseño e implementación de la búsqueda inteligente con SQL'
unidad: 'Unidad 3.2.7 — Ejercicio: Implementación de la búsqueda inteligente con consultas híbridas, vectoriales y de texto completo'
codigo: 3.2.7
...
# Unidad 3.2.7 — Ejercicio: Implementación de la búsqueda inteligente con consultas híbridas, vectoriales y de texto completo

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-intelligent-search-with-sql/07-exercise-implement-intelligent-search/)
