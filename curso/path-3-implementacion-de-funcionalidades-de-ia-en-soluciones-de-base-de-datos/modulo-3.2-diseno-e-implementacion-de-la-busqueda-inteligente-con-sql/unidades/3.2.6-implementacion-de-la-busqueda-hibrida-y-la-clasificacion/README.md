...
unidad: 'Unidad 3.2.6 — Implementación de la búsqueda híbrida y la clasificación'
codigo: 3.2.6
...
# Unidad 3.2.6 — Implementación de la búsqueda híbrida y la clasificación

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-intelligent-search-with-sql/06-implement-hybrid-search-ranking/)
