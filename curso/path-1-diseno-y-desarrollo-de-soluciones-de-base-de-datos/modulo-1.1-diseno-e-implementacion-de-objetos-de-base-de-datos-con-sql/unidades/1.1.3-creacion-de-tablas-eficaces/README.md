...
unidad: 'Unidad 1.1.3 — Creación de tablas eficaces'
codigo: 1.1.3
slug: 1.1.3-creacion-de-tablas-eficaces
categoria: leccion
url: https://learn.microsoft.com/es-mx/training/modules/design-implement-database-objects/3-design-implement-tables/
uid: learn.wwl.design-implement-database-objects.3-design-implement-tables
duracion_min: 8
...
# Unidad 1.1.3 — Creación de tablas eficaces

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-database-objects/3-design-implement-tables/)
