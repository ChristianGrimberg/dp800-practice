...
unidad: 'Unidad 1.1.9 — Ejercicio: Creación y mantenimiento de objetos de base de datos'
codigo: 1.1.9
...
# Unidad 1.1.9 — Ejercicio: Creación y mantenimiento de objetos de base de datos

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-database-objects/9-exercise-create-database-objects/)
