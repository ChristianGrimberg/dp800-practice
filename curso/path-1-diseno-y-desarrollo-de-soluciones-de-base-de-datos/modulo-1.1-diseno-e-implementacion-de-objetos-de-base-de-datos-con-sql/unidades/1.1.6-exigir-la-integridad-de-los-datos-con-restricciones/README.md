...
unidad: 'Unidad 1.1.6 — Exigir la integridad de los datos con restricciones'
codigo: 1.1.6
...
# Unidad 1.1.6 — Exigir la integridad de los datos con restricciones

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-database-objects/6-design-implement-constraints/)
