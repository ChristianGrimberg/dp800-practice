...
unidad: 'Unidad 1.1.7 — Administración de columnas e índices JSON'
codigo: 1.1.7
...
# Unidad 1.1.7 — Administración de columnas e índices JSON

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-database-objects/7-design-implement-json/)
