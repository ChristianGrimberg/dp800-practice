...
unidad: 'Unidad 1.1.5 — Uso de tipos de tabla especializados'
codigo: 1.1.5
...
# Unidad 1.1.5 — Uso de tipos de tabla especializados

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-database-objects/5-specialized-table-types/)
