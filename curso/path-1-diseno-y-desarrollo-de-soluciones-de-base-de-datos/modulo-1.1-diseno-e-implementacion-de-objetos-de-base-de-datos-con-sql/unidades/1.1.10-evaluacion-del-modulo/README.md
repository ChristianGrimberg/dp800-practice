...
unidad: 'Unidad 1.1.10 — Evaluación del módulo'
codigo: 1.1.10
slug: 1.1.10-evaluacion-del-modulo
categoria: quiz
url: https://learn.microsoft.com/es-mx/training/modules/design-implement-database-objects/10-knowledge-check/
uid: learn.wwl.design-implement-database-objects.10-knowledge-check
duracion_min: 10
...
# Unidad 1.1.10 — Evaluación del módulo

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/design-implement-database-objects/10-knowledge-check/)
