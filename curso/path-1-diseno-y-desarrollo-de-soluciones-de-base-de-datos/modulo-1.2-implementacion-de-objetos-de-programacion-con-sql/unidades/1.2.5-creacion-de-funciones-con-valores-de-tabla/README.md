...
unidad: 'Unidad 1.2.5 — Creación de funciones con valores de tabla'
codigo: 1.2.5
...
# Unidad 1.2.5 — Creación de funciones con valores de tabla

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-programmability-objects/5-create-table-valued-functions/)
