...
unidad: 'Unidad 1.2.4 — Creación de funciones escalares'
codigo: 1.2.4
...
# Unidad 1.2.4 — Creación de funciones escalares

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-programmability-objects/4-create-scalar-functions/)
