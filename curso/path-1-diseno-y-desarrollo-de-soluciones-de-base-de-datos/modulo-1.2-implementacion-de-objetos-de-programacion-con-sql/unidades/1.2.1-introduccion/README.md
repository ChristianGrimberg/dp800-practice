...
unidad: 'Unidad 1.2.1 — Introducción'
codigo: 1.2.1
slug: 1.2.1-introduccion
categoria: introduccion
url: https://learn.microsoft.com/es-mx/training/modules/implement-programmability-objects/1-introduction/
uid: learn.wwl.implement-programmability-objects.1-introduction
duracion_min: 2
...
# Unidad 1.2.1 — Introducción

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-programmability-objects/1-introduction/)

**Duración estimada**: 2 minutos · **Categoría**: introduccion
