...
unidad: 'Unidad 1.2.10 — Resumen'
codigo: 1.2.10
slug: 1.2.10-resumen
categoria: resumen
url: https://learn.microsoft.com/es-mx/training/modules/implement-programmability-objects/10-summary/
uid: learn.wwl.implement-programmability-objects.10-summary
duracion_min: 2
...
# Unidad 1.2.10 — Resumen

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-programmability-objects/10-summary/)

**Duración estimada**: 2 minutos · **Categoría**: resumen
