...
unidad: 'Unidad 1.2.8 — Ejercicio: Implementación de objetos de programación en SQL Server'
codigo: 1.2.8
...
# Unidad 1.2.8 — Ejercicio: Implementación de objetos de programación en SQL Server

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-programmability-objects/8-exercise-implement-programmability-objects/)
