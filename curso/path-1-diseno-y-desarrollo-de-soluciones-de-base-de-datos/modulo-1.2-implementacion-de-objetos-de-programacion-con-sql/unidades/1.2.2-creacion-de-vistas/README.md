...
unidad: 'Unidad 1.2.2 — Creación de vistas'
codigo: 1.2.2
...
# Unidad 1.2.2 — Creación de vistas

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/implement-programmability-objects/2-create-views/)
