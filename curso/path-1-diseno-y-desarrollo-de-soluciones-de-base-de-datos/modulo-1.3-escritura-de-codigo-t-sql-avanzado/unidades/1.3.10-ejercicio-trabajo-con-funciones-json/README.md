...
unidad: 'Unidad 1.3.10 — Ejercicio: Trabajo con funciones JSON'
codigo: 1.3.10
...
# Unidad 1.3.10 — Ejercicio: Trabajo con funciones JSON

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/write-advanced-sql-code/10-exercise-write-advanced-sql-code/)
