...
unidad: 'Unidad 1.3.1 — Introducción'
codigo: 1.3.1
...
# Unidad 1.3.1 — Introducción

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/write-advanced-sql-code/1-introduction/)
