...
unidad: 'Unidad 1.3.4 — Procesamiento de datos JSON con funciones integradas'
codigo: 1.3.4
...
# Unidad 1.3.4 — Procesamiento de datos JSON con funciones integradas

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/write-advanced-sql-code/4-json-functions/)
