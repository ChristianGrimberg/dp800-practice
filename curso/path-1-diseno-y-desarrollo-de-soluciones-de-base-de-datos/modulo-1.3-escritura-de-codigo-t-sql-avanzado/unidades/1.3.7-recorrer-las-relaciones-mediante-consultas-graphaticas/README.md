...
unidad: 'Unidad 1.3.7 — Recorrer las relaciones mediante consultas grapháticas'
codigo: 1.3.7
...
# Unidad 1.3.7 — Recorrer las relaciones mediante consultas grapháticas

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/write-advanced-sql-code/7-graph-queries/)

**Duración estimada**: 14 minutos · **Categoría**: leccion
