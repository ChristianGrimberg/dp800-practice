...
unidad: 'Unidad 1.3.3 — Aplicación de funciones de ventana para análisis'
codigo: 1.3.3
...
# Unidad 1.3.3 — Aplicación de funciones de ventana para análisis

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/write-advanced-sql-code/3-window-functions/)
