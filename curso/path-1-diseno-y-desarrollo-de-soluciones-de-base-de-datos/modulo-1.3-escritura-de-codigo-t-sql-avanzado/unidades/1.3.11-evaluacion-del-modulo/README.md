...
unidad: 'Unidad 1.3.11 — Evaluación del módulo'
codigo: 1.3.11
...
# Unidad 1.3.11 — Evaluación del módulo

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/write-advanced-sql-code/11-knowledge-check/)
