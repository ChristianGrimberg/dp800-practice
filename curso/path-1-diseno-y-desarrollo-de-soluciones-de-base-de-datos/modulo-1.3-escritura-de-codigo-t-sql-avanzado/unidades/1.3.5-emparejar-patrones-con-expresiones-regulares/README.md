...
unidad: 'Unidad 1.3.5 — Emparejar patrones con expresiones regulares'
codigo: 1.3.5
...
# Unidad 1.3.5 — Emparejar patrones con expresiones regulares

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/write-advanced-sql-code/5-regular-expressions/)
