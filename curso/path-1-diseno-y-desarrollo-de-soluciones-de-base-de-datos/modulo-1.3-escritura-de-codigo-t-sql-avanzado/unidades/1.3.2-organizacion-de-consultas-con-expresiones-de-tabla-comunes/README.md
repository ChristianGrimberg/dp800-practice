...
unidad: 'Unidad 1.3.2 — Organización de consultas con expresiones de tabla comunes'
codigo: 1.3.2
...
# Unidad 1.3.2 — Organización de consultas con expresiones de tabla comunes

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/write-advanced-sql-code/2-common-table-expressions/)
