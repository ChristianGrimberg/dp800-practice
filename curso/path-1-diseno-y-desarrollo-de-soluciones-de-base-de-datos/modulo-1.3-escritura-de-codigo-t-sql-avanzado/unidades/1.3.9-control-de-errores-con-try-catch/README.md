...
unidad: 'Unidad 1.3.9 — Control de errores con TRY...CATCH'
codigo: 1.3.9
...
# Unidad 1.3.9 — Control de errores con TRY...CATCH

**Fuente oficial**: [Unidad en Microsoft Learn (ES)](https://learn.microsoft.com/es-mx/training/modules/write-advanced-sql-code/9-error-handling/)
